            ...
            <div class="bg-white rounded-lg shadow-sm p-8">
                ...
                <ul class="space-y-6">
                    <li class="flex items-start">
                        <div class="flex-shrink-0 w-12 h-12 bg-[#ff551a] bg-opacity-10 rounded-lg flex items-center justify-center mr-4">
                ...
                <div class="mt-8 pt-8 border-t border-gray-200">
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="w-10 h-10 bg-[#ff551a] bg-opacity-10 rounded-lg flex items-center justify-center hover:bg-[#ff551a] hover:text-white transition-colors">
