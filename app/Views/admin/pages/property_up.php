    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="title text-center mb-12">
            <h2 class="text-2xl font-bold mb-2">
                Modifier le <span class="text-[#ff551a]">Bien</span>
            </h2>
                ...
                <form action="<?= base_url('admin/biens/update/' . $property['id']) ?>" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" name="description" required rows="4"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff551a] focus:border-transparent transition"
                                    placeholder="Décrivez le bien en détail..."><?= old('description', $property['description']) ?></textarea>
                            </div>
                                ...
                                <select id="type_id" name="type_id" required
                                    ...
                                    <?php if (isset($properties_type)): ?>
                                        <?php foreach ($properties_type as $type): ?>
                                            <option value="<?= $type['id'] ?>" <?= old('type_id', $property['type_id']) == $type['id'] ? 'selected' : '' ?>>
                                                <?= esc($type['name']) ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                    ...
                    <div class="pb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div
                                class="border-2 border-dashed border-[#ff551a] rounded-lg p-6 text-center hover:border-[#e64910] transition bg-orange-50">
